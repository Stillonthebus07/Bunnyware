-- ============================================================
-- Bunnyware V4.2 🐰 | Join discord.gg/6PJZa9BP7G for updates
...
local Window = Rayfield:CreateWindow({
    Name = "Bunnyware V4.2 🐰 | Join discord.gg/6PJZa9BP7G for updates",
    LoadingTitle = "Bunnyware V4.2",
    LoadingSubtitle = "by Aleksandra \"Drew\" Malinina | discord.gg/6PJZa9BP7G",
    ConfigurationSaving = {
        Enabled = true,
...
-- Infinite Jump (Infinite Yield style)
...
local returnLocation = "Map"  -- maxCoins is now hardcoded to 40
...
-- Max Coins slider removed – now fixed at 40
...
AutoTab:CreateToggle({
    Name = "Auto Reset on Max Coins (40)",
    CurrentValue = false,
    Flag = "AutoReset",
...
AutoTab:CreateToggle({
    Name = "Fling Murderer After Farm (40 coins)",
    CurrentValue = false,
...
MiscTab:CreateButton({
    ...
    Callback = function()
        ...
        local msg = string.format("Murderer: %s | Sheriff: %s | <<Bunnyware V4.2>>", murdName, sherName)
...
local MAX_COINS = 40  -- hardcoded maximum
...
RunService.Heartbeat:Connect(function()
    ...
    if autoResetOnMax and currentCoins >= MAX_COINS then
        -- Fling murderer if enabled
    ...
    if not u74 then
        ...
        if not targetCoin then
            -- No coins left – just return (don't fling here)
            return
        end
        u76 = targetCoin
        u74 = true
...
-- Final notification
Rayfield:Notify({
    Title = "Bunnyware V4.2 🐰",
    Content = "Loaded successfully! Join discord.gg/6PJZa9BP7G for updates.",
    Duration = 5,
})

print("✅ Bunnyware V4.2 loaded (Rayfield) by Aleksandra \"Drew\" Malinina")
