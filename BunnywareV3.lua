...
-- Floating buttons fixed – now visible on mobile.
-- ============================================================
...
-- ============================================================
-- COMBAT TAB (fixed floating buttons)
-- ============================================================
...
-- Floating button creation with cooldown and proper parenting
...
local function createFloatingButton(text, callback)
    ...
    -- Random position within screen bounds (using Scale)
...
-- Create floating button buttons (with cooldown)
CombatTab:CreateButton({
...
-- ============================================================
-- CORE ENGINE – AUTOFARM (unchanged)
-- ============================================================
local Players = game:GetService("Players")
