...
-- ============================================================
-- ESP TAB (modified: added murderer label with ghost detection)
-- ============================================================
...
local murdererLabelEnabled = false   -- new toggle

local espHighlights = {}
local espLabels = {}
local murdererLabels = {}   -- store BillboardGuis for murderer label
...
local function setupRoleListener()
    ...
    if success and remote then
        ...
        -- fallback: maybe the remote is different? we'll just ignore.
    end
end
setupRoleListener()
...
local function refreshESP()
    ...
    for _, pl in ipairs(Players:GetPlayers()) do
        if pl ~= LocalPlayer and pl.Character then
            ...
            -- Fallback: check for knife/gun in character/backpack
            ...
            -- Murderer label (even when ghost)
...
-- New toggle: Murderer Label (even when ghost)
ESPTab:CreateToggle({
...
-- ============================================================
-- COMBAT TAB (with integrated Deluxe fling)
-- ============================================================
